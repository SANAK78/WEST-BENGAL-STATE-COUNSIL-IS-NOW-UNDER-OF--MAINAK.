...
<ul>
<!--<li><a tabindex="-1"  href="Not-available">Employment</a></li>-->
<!--<li><a tabindex="-1"  href="Feedback">Public Services </a>
    <ul>-->
...
<!--li><a tabindex="-1" target="_blank"  href="https://webscte.co.in/assets/PDF/Right to Information Act, 2005.pdf">Right to Information</a></li-->
...
<!-- Carousel end-->  
<!-- Authority 
 <div class=" Box9 boxColour9 "  >
  
<a  href="Dept-Ministar"><div class="col-lg-3 col-md-3  hidden-sm hidden-xs  borderRS">
       <div class="col-lg-3 col-md-3  hidden-sm hidden-xs "> <img  src="https://webscte.co.in/assets/image/ministar_is.jpg"  alt="" ></div>
       <div class="col-lg-9 col-md-9  hidden-sm hidden-xs " >  <h1>Shri Indranil Sen</h1><h2>Minister of State (Independent Charge), TET&SD</h2></div>
       </div></a>
<a  href="Dept-Ministar"><div class="hidden-lg hidden-md col-sm-12 col-xs-12 borderB">
       <div class="hidden-lg hidden-md col-sm-3 col-xs-3" align="center">  <img   src="https://webscte.co.in/assets/image/ministar_is.jpg"   alt="" ></div>
       <div class="  hidden-lg hidden-md col-sm9 col-xs9"  style="margin-left: 17vh">  <h1  style="font-size:2.5vh; line-height:3vh ; ">Shri Indranil Sen</h1><h2 style="font-size:2.1vh; ">Minister of State (Independent Charge), TET&SD</h2></div>
       </div> </a>  

       <a href="Dept-Principa-Secretary"><div class="col-lg-3 col-md-3  hidden-sm hidden-xs  borderRS">
       <div class="col-lg-3 col-md-3  hidden-sm hidden-xs " >  </div>
       <div class="col-lg-9 col-md-9  hidden-sm hidden-xs ">  <h1>Dr. Krishna Gupta, IAS</h1><h2>Principal Secretary, TET&SD</h2></div>
       </div></a>
<a href="Dept-Principa-Secretary"><div class="hidden-lg hidden-md col-sm-12 col-xs-12 borderB">
       <div class="hidden-lg hidden-md col-sm-3 col-xs-3" align="center"> </div>
       <div class="  hidden-lg hidden-md col-sm9 col-xs9"  style="margin-left: 17vh" >  <h1  style="font-size:2.5vh; line-height:3vh ; ">Dr. Krishna Gupta, IAS</h1><h2 style="font-size:2.1vh; ">Principal Secretary</h2></div>
       </div> </a>
       <a href="Council-Charperson"><div class="col-lg-3 col-md-3  hidden-sm hidden-xs  borderRS">
       <div class="col-lg-3 col-md-3 hidden-sm hidden-xs " >  <img src="https://webscte.co.in/assets/image/ministar_pb.jpg"   alt="" ></div>
       <div class="col-lg-9 col-md-9  hidden-sm hidden-xs ">  <h1>Shri Purnendu Basu</h1><h2>Chairperson</h2></div>
       </div></a>
<a href="Council-Charperson"><div class="hidden-lg hidden-md col-sm-12 col-xs-12 borderB">
       <div class="hidden-lg hidden-md col-sm-3 col-xs-3" align="center">  <img  src="https://webscte.co.in/assets/image/ministar_pb.jpg"   alt="" ></div>
       <div class="  hidden-lg hidden-md col-sm9 col-xs9"  style="margin-left: 17vh" >  <h1  style="font-size:2.5vh; line-height:3vh ; ">Shri Purnendu Basu</h1><h2 style="font-size:2.1vh; ">Chairperson</h2></div>
       </div> </a>
       <a href="Council-CAO"><div class="col-lg-3 col-md-3  hidden-sm hidden-xs  borderRS">
       <div class="col-lg-3 col-md-3  hidden-sm hidden-xs " >  <img    src="https://webscte.co.in/assets/image/caon.jpg"  alt="" ></div>
       <div class="col-lg-9 col-md-9  hidden-sm hidden-xs ">  <h1>Smt. Saequa Monazza</h1><h2>Chief Administrative Officer</h2></div>
       </div></a>
<a href="Council-CAO"><div class="hidden-lg hidden-md col-sm-12 col-xs-12 borderB">
       <div class="hidden-lg hidden-md col-sm-3 col-xs-3" align="center">  <img    src="https://webscte.co.in/assets/image/caon.jpg"   alt="" ></div>
       <div class="  hidden-lg hidden-md col-sm9 col-xs9"  style="margin-left: 17vh">  <h1  style="font-size:2.5vh; line-height:3vh ; ">Smt. Saequa Monazza</h1><h2 style="font-size:2.1vh; ">Chief Administrative Officer</h2></div>
       </div> </a> 
        </div>
 Authority end-->        
<!-- content --> 
...
<div class="container-full">
	<div class="row nopadding">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 events_header">
			...
			<!--<div class="row">-->
   <!--             <div class="col-md-12">-->
   <!--     			<div class="Box2 boxColour5" style="background: #DAF7A6;">-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical & Sessional Examinations for the students of Diploma Examinations in Engineering & Technology/ MOPM/ 3DAG (1st Semester) January - 2025  <br />-->
   <!--     						<p class="text-danger"; style ="color:red;">Last date for filling up of Application Form has been EXTENDED upto 12.01.2025 (Upto 11.30 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #C4CF1F;color:black;">Click to Apply.... </a>-->
   <!--     			</div>-->
   <!--     		</div>-->
   <!--         </div>-->
			...
			<!--<div class="row">-->
   <!--             <div class="col-md-12">-->
   <!--     			<div class="Box2 boxColour5" style="background: #9CCDF1;">-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for Special Supplementary Examination of Back Subjects (Theoretical) in 1st to 6th semester for the outgoing students of Diploma in Engineering & Technology (September - 2024) <br />-->
   ...
   <!--     						<p class="text-danger"; style ="color:red;">Last date for filling up of Application Form is 30.08.2024 (Upto 11.30 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #0B86E1;color:black;">Click to Apply.... </a>-->
   <!--     			</div>-->
   <!--     		</div>-->
   <!--         </div>-->
   ...
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical & Sessional Examinations for the students of Diploma in Engineering & Technology / Architecture / MOPM / 3DAG (Even Semesters - June, 2024)  <br />-->
   <!--     						<p class="text-danger"; style ="color:red;">Last date for filling up of Application Form is 19.05.2024 (Upto 11.30 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #C1BE18;color:black;">Click to Apply.... </a>-->
   <!--     			</div>-->
   ...
   <!--     			<a href="https://webscte.co.in/assets/pdf_2023/SeatMatrixJEXPO-VACANCY FINAL 05.09.2023.pdf" target="_blank"><h1 style="text-transform: none;color:black;">VACANCY STATUS OF SPOT COUNSELLING FOR ADMISSION IN 1ST YEAR (SESSION 2023-24) </h1></a>-->
   <!--     			<a href="https://webscte.co.in/assets/pdf_2023/SeatMatrixJEXPO-VACANCY FINAL 05.09.2023.pdf" target="_blank" style="background: #ccccff;color:black;" class="mybutton buttColour3">Click to Download... <img src="https://webscte.co.in/assets/image/new.gif"></a>-->
   <!--     		  </div>-->
   <!--     		</div> -->
   <!--     		<div class="col-md-6">-->
   <!--     			<div class="Box2 boxColour3" style="background: #cc6699;">-->
   <!--     				<a href="https://webscte.co.in/assets/pdf_2023/SeatMatrixVOCLET-VACANCY FINAL 05.09.2023.pdf" target="_blank"><h1 style="text-transform: none;color:black;">VACANCY STATUS OF SPOT COUNSELLING FOR ADMISSION IN 2ND YEAR (SESSION 2023-24)</h1></a>-->
   <!--     				<a href="https://webscte.co.in/assets/pdf_2023/SeatMatrixVOCLET-VACANCY FINAL 05.09.2023.pdf" target="_blank" style="background: #ff9999;color:black;" class="mybutton buttColour3">Click to Download...<img src="https://webscte.co.in/assets/image/new.gif"></a>-->
   <!--     			</div>-->
   <!--     		</div>-->
   <!--     	</div>-->
			...
			<!--<div class="row">-->
   <!--             <div class="col-md-12">-->
   <!--     			<div class="Box2 boxColour5" style="background: #AEEFF6;">-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical / Sessional Examination for the students of Diploma in Engineering & Technology (4th & 6th Semesters) under OLD Syllabus to be held in SEPTEMBER-2023<br />-->
   <!--     						<p class="text-danger"; style ="color:red;">Last date for filling up of Application Form is 04.09.2023 (Upto 11.30 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #1F90CF;color:black;">Click to Apply.... </a>-->
   <!--     			</div>-->
   <!--     		</div>-->
   <!--         </div>-->
   ...
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical / Sessional Examination for the students of Diploma in Pharmacy (Part-I of NEW / OLD Syllabus) AUGUST-2023<br />-->
   <!--     						<p class="text-danger"; style ="color:red;">Last date for filling up of Application Form is 16.08.2023 (Upto 11.30 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #1F90CF;color:black;">Click to Apply.... </a>-->
   <!--     			</div>-->
   ...
   <!--         </div>-->
			...
			<!--   <div class="col-md-12">-->
   <!--             <div class="Box2 boxColour3" style="background: #fffc58;">-->
   <!--                 <a href="https://pharmacy.webscte.co.in/apply" class="nonview"><h1 style="text-transform: none;color:black;">Admit Card of PHARMACY ENTRANCE TEST (PET) - 2023</h1></a>-->
   <!--                 <a href="https://pharmacy.webscte.co.in/apply" style="background: #ffd258;color:black;" class="mybutton buttColour3">Click to Download.... <img src="https://webscte.co.in/assets/image/new.gif"></a>-->
   <!--               </div>-->
   <!--             </div> -->
			<!--</div>-->
      ...
      <!--  	</div>-->
			...
			<!--   <div class="col-md-12">-->
   <!--             <div class="Box2 boxColour3" style="background: #b5ff66;">-->
   <!--                 <a href="https://result.webscte.co.in/" class="nonview"><h1 style="text-transform: none;color:black;">Merit List of JEXPO / VOCLET - 2023</h1></a>-->
   <!--                 <a href="https://result.webscte.co.in/" style="background: #66b3ff;color:black;" class="mybutton buttColour3">Click to Check.... <img src="https://webscte.co.in/assets/image/new.gif"></a>-->
   <!--               </div>-->
   <!--             </div> -->
			<!--</div>-->
     ...
     <!--   				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
     <!--   					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
     <!--   						Apply online for External Theoretical Examination for the students of Diploma in Pharmacy (Part-II) under NEW / OLD SYLLABUS (JULY-2023)<br />-->
     <!--   						<p class="text-danger";>Last date for filling up of Application Form is 24.06.2023 (Upto 11.30 P.M.)</b></p>-->
     <!--   					</h1>-->
     <!--   				</a>-->
     <!--   				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #66b3ff;">Click to Apply.... </a>-->
     <!--   			</div>-->
     <!--   		</div>-->
     <!--       </div>-->
			...
			<!--   <div class="col-md-12">-->
   <!--             <div class="Box2 boxColour3" style="background: #fffc58;">-->
   <!--                 <a href="https://exam.webscte.co.in/JEXPO-VOCLET-ADMIT" class="nonview"><h1 style="text-transform: none;color:black;">Admit Card of JEXPO / VOCLET - 2023</h1></a>-->
   <!--                 <a href="https://exam.webscte.co.in/JEXPO-VOCLET-ADMIT" style="background: #ffd258;color:black;" class="mybutton buttColour3">Click to Download.... <img src="https://webscte.co.in/assets/image/new.gif"></a>-->
   <!--               </div>-->
   <!--             </div> -->
			<!--</div>-->
			<!--<div class="row">-->
   ...
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical Examination for the LATE ADMITTED students of Diploma in Engineering & Technology (1st & 3rd Semesters) under NEW SYLLABUS (May-2023)<br />-->
   <!--     						<p class="text-danger";>Last date for filling up of Application Form is 09.05.2023 (Upto 12.00 Noon)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   ...
   <!--         </div>-->
			<!--<div class = "row">-->
			<!--    <div class="col-md-12">-->
   <!--               <div class="Box2 boxColour3" style="background: #1dab35;">-->
   <!--                 <a href="https://exam.webscte.co.in/JEXPO-VOCLET" class="nonview"><h1 style="text-transform: none;">Online Application for JEXPO & VOCLET-2023 for admission to Diploma Courses in Engineering & Technology <br>(Academic Session 2023-24) <br><p style = "color:#b22222;">The last date of application by paying application fee has further been extended upto 20th May, 2023</p></h1></a>-->
   <!--                 <a href="https://exam.webscte.co.in/JEXPO-VOCLET" style="background: #217127;" class="mybutton buttColour3">Click to Apply </a>-->
   <!--               </div>-->
   <!--             </div>-->
			<!--</div>-->
			<!--<div class = "row" >-->
			<!--    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
   <!--               <div class="Box2 boxColour6" style="background: #58e0ff;">-->
   <!--                 <a href="https://pharmacy.webscte.co.in/apply" class="nonview"><h1 style="color: #000; font-weight: bold; text-transform: none;">Online Application for admission to<br>Diploma in Pharmacy (PHARM) and Hotel Management and Catering Technology (HMCT) <br>(Academic Session 2023-24) <br> <p style = "color:#b22222;">The last date of application by paying application fee has further been extended upto 20th May, 2023</p> </h1></a>-->
   <!--                 <a href="https://pharmacy.webscte.co.in/apply" class="mybutton buttColour6" style="background: #1c62b9;">Click to Apply </a>-->
   <!--               </div>-->
   <!--             </div>-->
			<!--</div>-->
		    ...
		    <!--<div class="row">-->
		    <!--    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">-->
      <!--            <div class="Box2 boxColour5" style="background: #fffc58;">-->
      <!--              <a href="https://exam.webscte.co.in/refund-upgradation-fee" class="nonview"><h1 style="font-weight: bold; text-transform: none;color: #000;">Application for Refund of Provisional Seat Booking Fee for the students who admitted through JEXPO-2021, JEXPO-2022, VOCLET-2021, VOCLET-2022 and PHARMACY-2021</h1></a>-->
      <!--              <a href="https://exam.webscte.co.in/refund-upgradation-fee" class="mybutton buttColour5" style="background: #66b3ff;color: #000;">Click to Apply  <img src="https://webscte.co.in/assets/image/new.gif"> </a>-->
      <!--            </div>-->
      <!--          </div>-->
		    <!--</div>-->
			<!--<div class="row">-->
   ...
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical / Sessional Examination for the students of Diploma in Engineering & Technology (5th Semester) under OLD SYLLABUS (April-2023)<br />-->
   <!--     						<p class="text-danger">Last date for filling up of Application Form is 18.04.2023 (Upto 11.30 P.M.)</p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #f90;">Click to Apply.... </a>-->
   <!--     			</div>-->
   ...
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical / Sessional Examination for the students of Diploma in Engineering & Technology (1st & 3rd Semesters) under NEW SYLLABUS (March-2023)<br />-->
   <!--     						<p class="text-danger";>Last date for filling up of Application Form <b>has FURTHER BEEN EXTENDED upto 02.04.2023 (Upto 2.00 P.M.)</b></p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #f90;">Click to Apply.... </a>-->
   <!--     			</div>-->
   ...
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="nonview">-->
   <!--     					<h1 style="color: #000; font-weight: bold; text-transform: none;">-->
   <!--     						Apply online for External Theoretical / Sessional Examination for the students of Diploma in Engineering & Technology (5th Semester) under NEW SYLLABUS (March-2023)<br />-->
   <!--     						<p class="text-danger">Last date for filling up of Application Form is 17.03.2023 (Upto 11.30 P.M.)</p>-->
   <!--     					</h1>-->
   <!--     				</a>-->
   <!--     				<a href="https://exam.webscte.co.in/exam-fees" class="mybutton buttColour5" style="background: #f90;">Click to Apply.... </a>-->
   <!--     			</div>-->
					...
					<div class="row">
						<div class="col-xs-12">
							<ul class="demo1" style="overflow-y: hidden; height: 240px;">
								...
								<li class="news-item">
									<a href="https://webscte.co.in/assets/pdf_2020/AICTE Pragati Scheme Guidelines.pdf" target="_blank">Guidelines for AICTE - Pragati Scholarship Scheme for girl students (2020-21) </a>
								</li>
								<li class="news-item">
									<a href="https://webscte.co.in/assets/pdf_2020/AICTE Saksham Scheme guidelines.pdf" target="_blank">Guidelines for AICTE – Saksham Scholarship Scheme for Specially Abled Student (2020-21) </a>
								</li>
								<li class="news-item">
									<a href="https://webscte.co.in/assets/PDF/Different Fees_wef 01-01-2020.pdf" target="_blank">Revised Fees w.e.f. 1st January, 2020 of Technical Education Division (TED) </a>
								</li>
								<li class="news-item">
									<a href="https://webscte.co.in/assets/pdf_2020/Notification RTI.pdf" target="_blank">Application under the RTI Act 2005 by the Students </a>
								</li>
							</ul>
						</div>
					</div>
...
<div id="styleswitcher">
        ...
        <label for="settings-btn" class="settings-box-element"><i class="fa fa-2x fa-sliders"></i></label>
        <div class="buttons-wrapper settings-box-element font-setting-buttons">
            <br>
            <p style="border:2px #000000 solid; margin: 15px 25px; padding:5px 1px 1px 1px">
            <a class="increase-me nonview1 b2h12" style="margin-right:15px ;padding-right:15px ; border-right:2px #000000 solid"><img height="21px" width="21px" src="https://webscte.co.in/assets/image/2.png" alt=""></a>
        <a class="reset-me nonview1" style="margin-right:15px ;padding-right:15px ; border-right:2px #000000 solid"><img height="18px" width="18px" src="https://webscte.co.in/assets/image/1.png" alt=""> </a>
        <a class="decrease-me nonview1 b2h12"><img height="14px" width="14px" src="https://webscte.co.in/assets/image/3.png" alt=""> </a>
                </p>

            <p><button id="demo-lunar" class="btn demo-btn demo-lunar" tabindex="-1">Default</button></p>
            
            <p><button id="demo-green" class="btn demo-btn demo-green" tabindex="-1">Green</button></p>
            <p><button id="demo-red" class="btn demo-btn demo-red" tabindex="-1">Red</button></p>
            <p><button id="demo-orange" class="btn demo-btn demo-orange" tabindex="-1">Orange</button></p>
 ...
 <footer id="myFooter">
        <div class="container-full">
            <div class="row">
                ...
                <div class="col-sm-4">
                   <a href="#" class="nonview"> <h5> Important Menus</h5></a>
                    <ul>
                        <li style=" font-size: 2px;">   <a href="#" class="nonview">&nbsp;</a></li>
                        
                       <li><i class="fa fa-calendar"></i><a href="https://webscte.co.in/Services-Tender">Tender Notice</a></li>

                        <li><i class="fa fa-bookmark"></i><a target="_blank" href="https://webscte.co.in/assets/pdf17/WBSCTE - Regulations 2013 (Final).pdf">Examination Regulations - 2013 (Amended)</a></li>
                        <li><i class="fa fa-bookmark"></i><a target="_blank" href="https://webscte.co.in/assets/pdf17/WBSCTE - Regulations 2008.pdf">Examination Regulations - 2008</a></li>
                        <li><i class="fa fa-file-text-o"></i><a href="Syllabus-part2-part3">Diploma Syllabus Part II & III</a></li>
                        <li><i class="fa fa-calendar"></i><a target="_blank" href="https://webscte.co.in/assets/academic_calender/Academic Calendar 2019-20.pdf">Academic Calender 2019-20</a></li>
                    </ul>
                </div>
               
                 <div class="col-sm-4">
                    <a href="#" class="nonview"><h5>Links</h5></a>
                    <ul >
                       
                        <li style=" font-size: 2px;">   <a href="#" class="nonview">&nbsp;</a></li>
                        <!--<li><a href="Notice"><i class="fa fa-newspaper-o"></i> Notice Board</a></li>-->
                       
                        <li><a href="https://www.youtube.com/c/wbsctvesd-ted"><i class="fa fa-youtube"></i> YouTube Channel </a></li>
                        ...
                        <li><a href="https://twitter.com/OfficialWBSCTE"><i class="fa fa-twitter"></i> Twitter </a></li>
                         <!--<li><a href="http://webscte.org/"><i class="fa fa-globe"></i> Website (Old Version)</a></li>-->
                    </ul>
                </div>
                <div class="col-sm-4">
                    <a href="#" class="nonview"><h5>Contact Details</h5></a>
                    <ul>
                    <li style=" font-size: 2px;">   <a href="#" class="nonview">&nbsp;</a></li>
  ...
  <tbody>
    <tr>
      ...
      <td> <a href="#" class="nonview">4th Floor, Plot No. B-7, AA-III, New Town Road, Opposite, Uniworld City, Newtown, Kolkata, West Bengal 700160, India</a></td>
    </tr>
  </tbody>
</table>
</li>
                       
                        <li> <a href="#" class="nonview"> <a href="#" class="nonview"><i class="fa fa-phone"></i>(033) 2227-7592 / 7590 </a></li>
                        <li> <a href="#" class="nonview"><i class="fa fa-envelope"></i><a href="mailto:examcell@webscte.co.in">examcell@webscte.co.in</a> </a></li>
			
                    </ul>
                </div>
               <div class="hidden-lg hidden-md  col-sm-12 col-xs-12 " style="padding-top: 0.71vh; padding-right: 1.021vh; color: #FFFFFF; font-weight: bold; " ><span  class="nonview" id="PPCount1"  ></span></div>
            </div>
...
<!-- footer end--> 
 <!-- Bootstrap technical-education-divition Slider Main JS File -->
   <script src="https://webscte.co.in/assets/js/technical-education-divition.js"></script>
      <!-- Script for notice board-->
   <script src="https://webscte.co.in/assets/js/jquery.min.js"></script>
<script src="https://webscte.co.in/assets/js/bootstrap.min.js"></script>

        <!-- Script for notice board-->

<script src="https://webscte.co.in/assets/js/jquery.js" type="text/javascript"></script>

   <script  src="https://webscte.co.in/assets/js/index.js"></script> 
   

     <!-- font-size-accessibility -->
    <script src="https://webscte.co.in/assets/js/jquery.font-accessibility.min.js"></script>
 ...
 <!-- STYLE SWITCHER -->
		  <script src="https://webscte.co.in/assets/js/demo.js"></script>
      
    <script src="https://webscte.co.in/assets/js/jquery.bootstrap.newsbox.min.js" type="text/javascript"></script>
    <script src="https://webscte.co.in/assets/js/home_page.js"></script>
